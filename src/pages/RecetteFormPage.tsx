...
export default function RecetteFormPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    console.log('📝 Tentative d\'enregistrement recette:', formData);
    ...
    try {
      const dataToSend = {
        ...
        provenance: formData.libelle,  // Copie pour compatibilité
      ...
      // Créer la recette
      const result = await createRecette.mutateAsync(dataToSend);
          ...
          <Card className="p-6">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex justify-end gap-3 pt-4 border-t">
                ...
                <Button type="submit" className="gap-2" disabled={createRecette.isPending}>
                  {createRecette.isPending ? (
                    <>
