...
const sectionOrder = ["Caisse", "Programmation", "Edition", "Rapports", "Administration"];

// Structure du menu basée sur le VB6 MENUCAISSS et MENUGEN
const menuItems: MenuItem[] = [
  // Section 1: Caisse - Opérations quotidiennes
  {
  ...
  // Section 3: Edition - Configuration
  {
    title: "Rubriques",
    icon: Tags,
    path: "/rubriques",
...
export function AppSidebar() {
  ...
  const groupedMenuItems = useMemo(() => {
    ...
    // Créer un objet trié selon sectionOrder
    ...
    // Ajouter les sections non définies dans l'ordre à la fin
